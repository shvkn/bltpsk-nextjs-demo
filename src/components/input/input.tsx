...
interface IInput extends Omit<React.HTMLProps<HTMLInputElement>, 'type'> {
  extraClass?: string;
  type: 'text' | 'dropdown';
}

export const Input: React.FC<IInput> = ({ type, label, name, extraClass, ...rest }) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.inputContainer}>
        <input {...rest} ref={inputRef} type='text' name={name} className={classNames(styles.input, extraClass)} />
        {isDropDown && (
